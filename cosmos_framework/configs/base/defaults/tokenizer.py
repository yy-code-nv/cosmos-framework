...
PRETRAINED_TOKENIZER_UNIAE_4X16X16_C48_T32TO160_MIXP_FPS_MIX_ENCODER_NONCAUSAL_DECODER_NONCAUSAL_NOGAN_S3_QWEN0P6B_VAE_PTH = (
...
UniAE4x16x16C48T32to160MixpFpsMixEncoderNoncausalDecoderNoncausalNoganS3Qwen0p6bVAEConfig: LazyDict = L(
    UniAEVAEInterface
)(
    bucket_name=PLACEHOLDER,
    object_store_credential_path_pretrained=PLACEHOLDER,
    vae_path=PRETRAINED_TOKENIZER_UNIAE_4X16X16_C48_T32TO160_MIXP_FPS_MIX_ENCODER_NONCAUSAL_DECODER_NONCAUSAL_NOGAN_S3_QWEN0P6B_VAE_PTH,
    spatial_compression_factor=16,
    temporal_compression_factor=4,
    pixel_trim=True,
    causal=False,
...
def register_tokenizer():
    ...
    cs.store(
        ...
        node=UniAE4x16x16C48T32to160MixpFpsMixEncoderNoncausalDecoderNoncausalNoganS3Qwen0p6bVAEConfig,
    )
    # Flux tokenizer
